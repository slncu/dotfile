...
var StyledTemplateLanguageService = /** @class */ (function () {
    ...
    StyledTemplateLanguageService.prototype.getCodeFixesAtPosition = function (context, start, end, errorCodes, format) {
        var doc = this.createVirtualDocument(context);
        var stylesheet = this.scssLanguageService.parseStylesheet(doc);
    ...
    StyledTemplateLanguageService.prototype.getCompletionItems = function (context, position) {
        ...
        var doc = this.createVirtualDocument(context);
        var virtualPosition = this.toVirtualDocPosition(position);
        var stylesheet = this.scssLanguageService.parseStylesheet(doc);
        var emmetResults = {
            isIncomplete: true,
            items: [],
    ...
    StyledTemplateLanguageService.prototype.translateTextEditToFileTextChange = function (context, textEdit) {
        var start = context.toOffset(this.fromVirtualDocPosition(textEdit.range.start));
        var end = context.toOffset(this.fromVirtualDocPosition(textEdit.range.end));
        return {
