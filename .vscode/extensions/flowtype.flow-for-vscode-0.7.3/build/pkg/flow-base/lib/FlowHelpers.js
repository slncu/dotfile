...
var getPathToFlow = function () {
  var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
    var workspaceRoot, config, shouldUseNodeModule, userPath, nodeModuleFlowPath, extensionRoot;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            workspaceRoot = global.vscode.workspace.rootPath;
            config = global.vscode.workspace.getConfiguration('flow');
            shouldUseNodeModule = config.get('useNPMPackagedFlow');
            userPath = config.get('pathToFlow').replace('${workspaceRoot}', workspaceRoot);
            nodeModuleFlowPath = nodeModuleFlowLocation(workspaceRoot);
